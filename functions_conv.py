...
# =============================================================================
def conv2d_simple(self, x, W, b=None, stride=1, pad=0):
    ...
    #カーネルを1列に並べている
    #-1をreshapeで使用すると、辻褄が会うようにしてくれる
    Weight = Weight.reshape(OC, -1).transpose()
    #行列の積の計算をする。線形変換かつパイアスを含めた計算
    t = linear(col, Weight, b)
    #出力サイズを適切なサイズに整形してくれる。
    #transpose関数を使えば、テンソルの軸の順番を入れ替えてくれる
